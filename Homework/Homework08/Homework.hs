...
-- "Sangiovese", "Cabernet-sauvignon", "Merlot" and "Garnacha"
grapes :: [Grape]
...
castiglioni = Label {n = "Castiglioni", g = "Sangiovese", r = tuscany, k = Red}
...
lePetitHaitLafitte = Label {n = "Le Petit Haut Lafitte", g = "Merlot", r = ("Bordeaux", "France"), k = Red}
...
containsGrape labels grape = any (\i -> (g i) == grape) grapeList